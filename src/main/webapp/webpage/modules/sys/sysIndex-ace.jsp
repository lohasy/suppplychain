					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${fns:getUser().photo}" alt="User Photo" onerror="this.src='${ctxStatic}/images/userinfo.jpg';this.onerror=null" />
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">拓维软件</span>
							 &copy; 2018
						</span>
