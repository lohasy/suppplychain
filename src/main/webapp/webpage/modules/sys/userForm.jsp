		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         ...
		         <td  class="width-15"  class="active">	<label class="pull-right"><font color="red">*</font>机构类型:</label></td>
		         <td class="width-35"><sys:treeselect id="company" name="company.id" value="${user.company.id}" labelName="company.name" labelValue="${user.company.name}"
						title="机构" url="/sys/office/treeData?type=1" cssClass="form-control required"/></td>
		      </tr>
		      
		      <tr>
		         <td class="active"><label class="pull-right">所属公司:</label></td>
				 ...
				 <td>
	         		...
	         		<select style="margin-top: 5px;padding:0 12px; width: 200px;" id="gys-company" name="supplier.id" val="${user.supplier.id}" class="input-sm form-control input-s-sm inline">
