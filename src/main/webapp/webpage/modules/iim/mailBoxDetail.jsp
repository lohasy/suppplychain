...
<!--                         <a href="#" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="标为垃圾邮件"><i class="fa fa-trash-o"></i> </a> -->
                    ...
                    <div class="mail-tools tooltip-demo m-t-md">
                        ...
                        <h3>
                        <span class="font-noraml">标题： </span>${mailBox.mail.title }
                    </h3>
                        <h5>
                        <span class="pull-right font-noraml"><fmt:formatDate value="${mailBox.sendtime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                        <span class="font-noraml">消息来源： </span>${(fns:getUserById(mailBox.sender)).name}
                        </h5>
                        <h5>
                        <span class="font-noraml">收信息人员： </span>${(fns:getUserById(mailBox.receiver)).name}
                    </h5>
                    </div>
                </div>
                <div class="mail-box">
...
<%--                         <a class="btn btn-sm btn-white" href="${ctx}/iim/mailCompose/replyLetter?id=${mailBox.id}"><i class="fa fa-reply"></i> 回复</a> --%>
                       <!--   <a class="btn btn-sm btn-white" href="#"><i class="fa fa-arrow-right"></i> 下一封</a>
                        ...
                        <button title="" onclick="return confirmx('确认要删除该消息吗？', '${ctx}/iim/mailBox/delete?id=${mailBox.id}')"  data-placement="top" data-toggle="tooltip" data-original-title="删除消息" class="btn btn-sm btn-white"><i class="fa fa-trash-o"></i> 删除</button>
                    </div>
                    <div class="clearfix"></div>
