...
<body style="background-color: #fff;">
	<form name="inputForm" id="inputForm" class="form-horizontal" action="${ctx}/yfzk/hxqyBillHkSave" accept-charset="UTF-8" method="post"  enctype="multipart/form-data">
		<input type="hidden" name="str" value="3"/>
    	...
    	<div class="popup_tian clear" style="width: 100%;">
      		<div class="upload_ti" style="width: 100%;">根据融资申请金额为<font color="#ff0000"><fmt:formatNumber type="currency" currencySymbol="￥" value="${financing.loanAmount}" /></font>元，您应该还银行<font color="#ff0000">${financing.loanAmount}</font>元</div>
      		<div class="popup_hang" style="width: 100%;">
        		<span class="supplier_name">还款金额(元)：</span>
        		<input type="text" class="text1" id="repayment_amount" readonly="readonly" name="loanamount" value="${financing.loanAmount}" placeholder="请输入还款金额（元）" />
