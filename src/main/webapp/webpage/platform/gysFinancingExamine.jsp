...
<head>
	...
	<script>
		...
		//融资审核
		function financingExamine(state){
			if(!$("#isagree").is(':checked')){
				layer.msg('请先勾选同意《应收账款转让通知书》！', {shift: 6});
				return;
			}
			$("#state").val(state);
			$("#mgmtform").submit();
	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
    		...
    		<div class="ibox-content">
				...
				<form name="mgmtform" id="mgmtform" enctype="multipart/form-data" action="${ctx}/rzglall/financing-examine" accept-charset="UTF-8" method="post">
					...
					<div class="main_body clear" style="width: 100%; margin: 0 auto 0 auto;">
  						<div class="supplier clear" style="width: 100%; top: 0px; padding: 0 30px 0 30px;">  
    						...
    						<div class="account_yue">
    							...
    							<a href="javascript:void(0);">《应收账款转让通知书》</a>
    						</div>
    						<div class="account_bot clear" style="height: 57px; line-height: 40px;">
    							<a href="javascript:void(0);" id="apply" onclick="financingExamine('4')" style="margin-right: 18px;">融资签约</a>
    							<a href="javascript:void(0);" id="agreesign" onclick="financingExamine('2')" style="margin-right: 20px; background: #40d0a7;">不同意</a>
