...
<html>
<head>
	<title>核心企业--应付账款管理--批量上传应付账款</title>
...
<body style="background-color: #fff;">
	<form name="inputForm" id="inputForm" class="form-horizontal" action="${ctx}/yfzk/import?coreEnterpriseId.id=${bill_info.coreEnterpriseId.id}" accept-charset="UTF-8" enctype="multipart/form-data" method="post">
		<div>
