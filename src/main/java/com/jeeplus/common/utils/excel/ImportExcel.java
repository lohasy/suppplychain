				...
				if (val != null){
					...
					try {
						...
						if (valType == String.class){
							...
							if(val != null && !Utils.isEmpty(val.toString())) {
					...
					// set entity value
					if (os[1] instanceof Field){
						if(((Field)os[1]).getName().equals("supplierEnterpriseId")) {
							Supplier_enterprise supplier_enterprise = new Supplier_enterprise();
							supplier_enterprise.setName(val + "");
							((Bill_info)e).setSupplierEnterpriseId(supplier_enterprise);
						}else {
