...
public class LocalCache {
    ...
    protected static Logger logger = LoggerFactory.getLogger(LocalCache.class);
    //默认的缓存容量  
    ...
    //使用默认容量创建一个Map
    public static ConcurrentHashMap<String, CacheEntity> cache = new ConcurrentHashMap<String, CacheEntity>(
            DEFAULT_CAPACITY);
