...
public class User extends DataEntity<User> {
	...
	private Area provinceId; //备用字段
	private Area cityId; //省市区域
	...
	//核心企业
	private Core_enterprise core;
	//供应商
	private Supplier_enterprise supplier;
	...
	public Core_enterprise getCore() {
		return core;
	}

	public void setCore(Core_enterprise core) {
		this.core = core;
	}

	public Supplier_enterprise getSupplier() {
		return supplier;
	}

	public void setSupplier(Supplier_enterprise supplier) {
